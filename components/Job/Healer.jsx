...
const product = {
    ...
    images: [
        {
            src: './images/role/star.png',
            alt: 'Two each of gray, white, and black shirts laying flat.',
        },

    ],
    sizes: [
        { name: '백마도사', inStock: true },
        { name: '점성술사', inStock: true },
        { name: '학자', inStock: true },
        { name: '현자', inStock: true },
    ],
    description:
    ...
    return (
        <div className="mt-32 ">
            <div className="mb-32 hero container max-w-screen-lg  mx-auto flex justify-center">
                ...
                <img className=' w-16 mt-2.5 mr-6' src='./images/role/role_healers.svg' />
